        ...
        extends Table
{
    ...
    public MetricSamplesTable()
    {
        schema = new SchemaBuilder().newBuilder()
                ...
                .addStringField(DIM_NAME_1)
                .addStringField(DIM_VALUE_1)
                .addStringField(DIM_NAME_2)
                .addStringField(DIM_VALUE_2)
                .addStringField(DIM_NAME_3)
                .addStringField(DIM_VALUE_3)
                .addStringField(DIM_NAME_4)
                .addStringField(DIM_VALUE_4)
                .addStringField(DIM_NAME_5)
                .addStringField(DIM_VALUE_5)
                .addStringField(DIM_NAME_6)
                .addStringField(DIM_VALUE_6)
                .addStringField(DIM_NAME_7)
                .addStringField(DIM_VALUE_7)
                .addStringField(DIM_NAME_8)
                .addStringField(DIM_VALUE_8)
                .addStringField(DIM_NAME_9)
                .addStringField(DIM_VALUE_9)
                .addStringField(DIM_NAME_10)
                .addStringField(DIM_VALUE_10)
                ...
                .addMetadata(DIM_NAME_1,"Name of the dimension")
                .addMetadata(DIM_VALUE_1, "Value of the dimension")
                .addMetadata(DIM_NAME_2,"Name of the dimension")
                .addMetadata(DIM_VALUE_2, "Value of the dimension")
                .addMetadata(DIM_NAME_3,"Name of the dimension")
                .addMetadata(DIM_VALUE_3, "Value of the dimension")
                .addMetadata(DIM_NAME_4,"Name of the dimension")
                .addMetadata(DIM_VALUE_4, "Value of the dimension")
                .addMetadata(DIM_NAME_5,"Name of the dimension")
                .addMetadata(DIM_VALUE_5, "Value of the dimension")
                .addMetadata(DIM_NAME_6,"Name of the dimension")
                .addMetadata(DIM_VALUE_6, "Value of the dimension")
                .addMetadata(DIM_NAME_7,"Name of the dimension")
                .addMetadata(DIM_VALUE_7, "Value of the dimension")
                .addMetadata(DIM_NAME_8,"Name of the dimension")
                .addMetadata(DIM_VALUE_8, "Value of the dimension")
                .addMetadata(DIM_NAME_9,"Name of the dimension")
                .addMetadata(DIM_VALUE_9, "Value of the dimension")
                .addMetadata(DIM_NAME_10,"Name of the dimension")
                .addMetadata(DIM_VALUE_10, "Value of the dimension")
                .build();
